...
export default function Walmart() {
    ...
    const getupdatedproduct = async (account) => {
        try {
            if (account) {
                console.log(account)
                let res = await fetch(`${local}/scrap/walmart/currentdetails`, {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
    ...
    const fetchbrand = async () => {
        ...
        if (resp) {
            if (num > 0) {
                ...
                setLoading(true)
                let result = await fetch(`${local}/scrap/walmart/fetchurl`, {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
    ...
    const fetchurl2 = async () => {
        let res = await fetch(`${local}/scrap/walmart/fetchurl2`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
    ...
    async function refreshdetails() {
        let res = await fetch(`${local}/scrap/walmart/refreshdetails`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
    ...
    const downloadProductExcel = async () => {
        let res = await fetch(`${local}/scrap/walmart/downloadProductExcel`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({ account: profile.account })
        });
    ...
    async function deleteoldurls() {
        ...
        if (ans) {
            let res = await fetch(`${local}/scrap/walmart/deleteoldurls`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ account: profile.account })
            })
