                ...
                <div className="datacontainer" style={{ transition: '2s' }}>
                    <div className="container-fluid searchboxcontanier">
                        <div className="row d-flex align-items-center">
                            <div className="col-md-4 col-sm-6 tableheading"><img src="/static/return.png" alt="" /> <TypeAnimation sequence={[`Returned Orders -  ${result.length}`, 4000,]} wrapper="span" speed={20} />
                            </div>
