...
export default function PrepEmployee() {
    ...
    useEffect(() => {
        let token = localStorage.getItem('gstar_prep_employee')
...
function refresh(){
    ...
    return (
        <>
            <Header profile={{ user: profile.name, role: 'gster_om_employee' }} />
            {loading && (
            ...
            <div className="container ps-4 pe-4" style={{ opacity: loading ? 0.1 : 1, color: loading ? 'black' : null, zIndex: '10000', width: '100vw', minHeight: '100vh' }}>
                <div className="container-fluid p-2 searchboxcontanier">
                    <div className="row">
                        <div className="col-md-7 col-sm-12">
                            <ul className='d-flex justify-content-evenly fs-5 links' style={{ listStyle: 'none' }}>
                                <li><button className='nobtn'><a href="#todaydata" className='text-white'>Today's Entry</a></button></li>
                                <li><button className='nobtn'><a href="#untrackable" className='text-white'>Untrackable</a></button></li>
                                <li><button className='nobtn text-white'>PDF require</button></li>
                                <li><button className='nobtn text-white'>Unshipped</button></li>
                            </ul>
                        </div>
                ...
                <div className="container-fluid p-4 d-flex flex-column align-items-center">
                    <Suspense fallback={<div>Loading...</div>}>
                        <Unshipped state={{ account: profile.account, role: profile.role }} />
                    </Suspense>
                </div>
            ...
            {Array.isArray(todayEntry) && todayEntry[0]?._id &&
                    <div className="datacontainer">
                        <div className="container-fluid p-2 searchboxcontanier">
                            <div className="row">
                                <div className="col-md-3 col-sm-6 hd fs-3"> <TypeAnimation sequence={[`Status updated today -  ${todayEntry.length}`, 4000,]} wrapper="span" speed={20} />
                                </div>
                                <div className="col-md-5 col-sm-12">
                                    <div className="searchbox d-flex justify-content-evenly w-100">
                                        <Dropdown as={ButtonGroup}>
                                ...
                                <div className="col-md-3 col-sm-6 d-flex">
                                             <button className='nobtn text-white' onClick={refresh}> Refresh
                                             <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="ms-2 bi bi-arrow-clockwise" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M8 3a5 5 0 1 0 4.546 2.914.5.5 0 0 1 .908-.417A6 6 0 1 1 8 2z"/>
  <path d="M8 4.466V.534a.25.25 0 0 1 .41-.192l2.36 1.966c.12.1.12.284 0 .384L8.41 4.658A.25.25 0 0 1 8 4.466"/>
</svg></button>                                </div>
                                <div className="col-md-1 col-sm-6 searchbox">
                                    {/* <button onClick={search} className='border border-secondary ms-2 p-2'>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="white" className="bi bi-search" viewBox="0 0 16 16">
                                            <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001q.044.06.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1 1 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0" />
                                        </svg>
                                    ...
                                    {/* <button onClick={hideuntrackable} className='border border-secondary ms-2 p-2 bg-danger'><span className="text-white me-2 ms-2 mt-2">Hide</span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="red" className="bi bi-x-lg" viewBox="0 0 16 16">
                                        <path d="M2.146 2.854a.5.5 0 1 1 .708-.708L8 7.293l5.146-5.147a.5.5 0 0 1 .708.708L8.707 8l5.147 5.146a.5.5 0 0 1-.708.708L8 8.707l-5.146 5.147a.5.5 0 0 1-.708-.708L7.293 8z" />
                                    </svg>
                                </button> */}
                                </div>
