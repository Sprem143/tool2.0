...
export default function OmAdminSignup() {
    ...
    return (
        <>
            ...
            <div className="container" style={{ opacity: loading ? 0.1 : 1, color: loading ? 'black' : null, zIndex: '10000', paddingLeft: '12vw', paddingRight: '12vw' }}>
                <motion.h1
                ...
                <div className="row">
                    <div className="col-md-7 col-sm-12">
                        <motion.img
                            ...
                            src="/static/signup.png" alt="" height='90%' />
                    </div>
                    <div className="col-md-5 col-sm-12">
                        <div className="d-flex justify-content-center align-items-center mt-4">
                            ...
                            >
                                <Card className="p-4 mb-2 shadow-sm bg-dark text-white login">
                                    <h2 className="text-center">Admin Sign Up</h2> <hr />
                                    {formdata.img &&
                                    ...
                                    <div>
                                        ...
                                        {otp && <p className="text-success">OTP sent successfully</p>}
                                        ...
                                        {isVerified && <p className="text-white fs-5 bg-success">OPT verified</p>}
                                        ...
                                        <input type="file" accept=".jpg ,.png, .jpeg" onChange={(e) => uploadprofilepic(e.target.files[0])} />
